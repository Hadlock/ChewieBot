...
function getKickReasons()
{
	$kickReasonsURL = 'http://bfgoons.com/lolocaust/kickreasons';
	
	$kickReasons = preg_split('/\n/', file_get_contents($kickReasonsURL));
	array_pop($kickReasons);
